...
try {
    ...
    // --- ENDE NEU ---
        ...
        navUsers.style.display = 'none';
        // --- START NEU: Feedback-Link für Standard-User/Hundeführer ausblenden ---
        navFeedback.style.display = 'none';
        // --- ENDE NEU ---
    }
    // --- ENDE NEU ---

    // --- START NEU: Zugriffsschutz für Planschreiber/Hundeführer auf dieser Seite ---
    ...
    if (isVisitor || !isAdmin) {
        ...
        // Besucher, Standard-User, Planschreiber und Hundeführer werden geblockt.
        ...
        // --- START NEU: "Planschreiber/Hundeführer" zur Fehlermeldung hinzugefügt ---
        throw new Error("Besucher/User/Planschreiber/Hundeführer darf Benutzerverwaltung nicht sehen.");
        // --- ENDE NEU ---
    ...
    // --- START NEU: "Planschreiber/Hundeführer" zur Fehlermeldung hinzugefügt ---
    if (!e.message.includes("Besucher/User/Planschreiber/Hundeführer")) {
         logout();
    }
    // --- ENDE NEU ---
}
