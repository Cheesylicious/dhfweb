...
class ShiftQuery(db.Model):
    ...
    __table_args__ = (
        ...
        # (WICHTIG: Der UNIQUE KEY _user_date_status_uc in der LIVE-DB
        # wurde in der letzten Interaktion als Problem identifiziert und
        # serverseitig in routes_queries.py behandelt, nicht im Modell.)
    )
