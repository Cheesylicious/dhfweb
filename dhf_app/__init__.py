...
def create_default_email_templates(db_instance):
    ...
    defaults = [
        ...
        {"key": "wish_shift_changed", "name": "Genehmigte Wunschschicht nachträglich geändert", "subject": "DHF-Planer: Deine Wunschschicht am {datum} wurde geändert", "body": "Hallo {vorname},\n\ndeine genehmigte Wunschschicht am {datum} wurde nachträglich von {wunschschicht} auf {neue_schicht} geändert.\n\nBitte prüfe den Schichtplan für Details.", "description": "Wird optional gesendet, wenn eine bereits genehmigte Wunschschicht nachträglich überschrieben wird.", "placeholders": "{vorname}, {name}, {datum}, {wunschschicht}, {neue_schicht}"},
